...
export default {
  data() {
    return {
		//微信开发者工具中没有配置request 合法域名列表，所以加载不出来
		// bgImage: 'http://yunhaicard-public-sz.oss-cn-shenzhen.aliyuncs.com/resources/yunhiadingzhi/map/image/%E5%8C%85%E8%A3%85%E7%9B%92.png',
		bgImage:'',
		history: []
    };
  },
