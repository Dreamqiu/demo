<template>
	<view class="container">
		<view class="cropper-wrap">
			<image-cropper id="image-cropper" ref="cropper" :zoom="1" :angle="0" :max-zoom="3" :min-zoom="0.5" :src="src" @load="load"
			 @error="errHandle" @cropped="cropped" @afterDraw="afterDraw" @beforeDraw="beforeDraw" />
		</view>
		<image :src="img" mode="aspectFit" style="position: absolute; bottom: 0;width: 400rpx;left: 0;" />
